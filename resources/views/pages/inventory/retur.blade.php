...
@section('container')
    <div class="rounded-lg bg-white p-6 shadow-lg">
        ...
        <div class="mb-4 grid grid-cols-2 gap-4">
            <div>
                <label class="block font-medium text-gray-700">Nama Obat</label>
                <p class="mt-1 text-gray-600">Paracetamol</p>
            </div>
            <div>
                <label class="block font-medium text-gray-700">Tanggal Expired</label>
        ...
        <div class="mb-4 grid grid-cols-2 gap-4">
            <div>
                <label class="block font-medium text-gray-700">Jumlah Obat (pcs)</label>
                <input type="number" class="h-10 w-full rounded border border-gray-300 p-4"
                    placeholder="Inputkan jumlah obat" />
            </div>
            <div>
                <label class="block font-medium text-gray-700">Deskripsi</label>
                <textarea class="h-40 w-full rounded border border-gray-300 p-4" placeholder="Tuliskan alasan" rows="4"></textarea>
            </div>
        </div>
        ...
        <div id="toast-success"
            ...
            <div class="ml-3 font-normal">Retur berhasil dilakukan!</div>
