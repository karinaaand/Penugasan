...
<div class="p-6 bg-white rounded-lg shadow-lg">
    ...
    <div class="flex justify-end mt-4">
        <button onclick="showToast()" class="bg-yellow-400 text-black font-bold py-2 px-6 rounded-lg shadow-md hover:bg-yellow-500 transition-colors" style="width: 100px; height: 40px;">
            Retur
        </button>
    </div>
