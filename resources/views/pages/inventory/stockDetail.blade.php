                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-6 text-center">
                            <a href="{{ route('inventory.retur', 1) }}"
                                class="bg-yellow-500 text-white text-sm px-4 py-2 rounded-lg shadow hover:bg-yellow-600 transition-colors duration-200">Retur</a>
                            <a href="{{ route('inventory.trash', 1) }}"
                                class="bg-red-500 text-white text-sm px-4 py-2 rounded-lg shadow hover:bg-red-600 transition-colors duration-200">Buang</a>
                        </td>
                    </tr>
                    <!-- Data Row 2 -->
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
