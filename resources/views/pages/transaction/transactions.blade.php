...
<div class="shadow-lg p-4 rounded-md">
    <table class="w-full text-sm text-center border border-gray-300 rounded-lg p-4 overflow-hidden shadow-lg">
        ...
        <tbody>
            @for ($i = 0; $i < 10; $i++)
            <tr class="border-b" >
                <td class="py-3">AAA111</td>
                <td class="py-3">20 Januari 2024</td>
                <td class="py-3">07.56</td>
                <td class="flex justify-center py-3"><a href="{{ route('transaction.show',1) }}" class="bg-indigo-200 hover:bg-indigo p-2 rounded-md"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
