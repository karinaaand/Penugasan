    ...
    <table class="w-full">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="flex justify-center py-3"><a href="{{ route('transaction.show',1) }}" class="bg-lavender-200 hover:bg-lavender p-1 rounded-md"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
