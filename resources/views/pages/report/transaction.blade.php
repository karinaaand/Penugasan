    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <table class="min-w-full leading-normal">
            <thead class="bg-gray-200 text-sm">
                ...
                <th class="py-4 text-base font-inter">KUANTITI</th>
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                    <td class="text-center py-3 text-base font-inter">1</td>
                    <td class="text-center py-3 text-base font-inter">#AAA111</td>
                    <td class="text-center py-3 text-base font-inter">27 Januari 2025</td>
                    <td class="text-center py-3 text-base font-inter">LPB</td>
                    <td class="text-center py-3 text-base font-inter">100</td>
                    <td class="text-center py-3 text-base font-inter">Rp 50.000</td>
                    <td class="flex justify-center py-3"><a href="{{ route('report.transactions.show',1) }}" class="bg-lavender-200 hover:bg-lavender p-1 rounded-md"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
