        ...
        <div class="overflow-hidden rounded-lg bg-white shadow-md">
            <table class="min-w-full leading-normal">
                <thead class="bg-gray-200 text-sm">
                    ...
                    <th class="py-4 text-center text-base font-inter">STOK KONVERSI</th>
                    <th class="py-4 text-center text-base font-inter">EXP TERDEKAT</th>
                    <th class="py-4 text-center text-base font-inter">STATUS</th>
                    <th class="py-4 text-center text-base font-inter">ACTION</th>
                </thead>
                <tbody>
                    @for ($i = 0; $i < 10; $i++)
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            <td class="py-3 text-center text-base font-inter">{{ $i + 1 }}</td>
                            <td class="py-3 text-center text-base font-inter">#AAA111</td>
                            <td class="py-3 text-center text-base font-inter">Paracetamol Gatau Apa Merk nya</td>
                            <td class="py-3 text-center text-base font-inter">70 Box</td>
                            <td class="py-3 text-center text-base font-inter">20 Januari 2024</td>
                            <td class="py-3 text-center text-base font-inter">-</td>
                            <td class="flex justify-center py-3">
                                <a href="{{ route('report.drugs.show', 1) }}"
                ...
                <div class="flex justify-end">
                    <nav class="relative z-0 inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                        <a href="#"
                            ...
                            < </a>
                                <a href="#"
                                    class="border border-gray-300 bg-white px-3 py-2 text-gray-500 hover:bg-gray-100">
                                    1
                                </a>
                                <a href="#"
                                    class="border border-gray-300 bg-white px-3 py-2 text-gray-500 hover:bg-gray-100">
