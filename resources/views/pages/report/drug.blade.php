...
@section('container')
    <div class="rounded-lg bg-white p-6 shadow-lg">
        ...
        <div class="flex flex-1 justify-end">
            <button id="printButton" class="rounded-lg bg-yellow-400 px-4 py-2 font-bold text-black mb-4">CETAK</button>
        </div>
                ...
                <tbody>
                    @for ($i = 0; $i < 10; $i++)
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-3 text-center">#AAA111</td>
                            <td class="py-3 text-center">Paracetamol Gatau Apa Merk nya</td>
                            <td class="py-3 text-center">70 Box</td>
                            <td class="py-3 text-center">20 Januari 2024</td>
                            <td class="py-3 text-center">-</td>
                            <td class="flex justify-center py-3">
                                <a
                                    href="{{ route('report.drugs.show', 1) }}"
