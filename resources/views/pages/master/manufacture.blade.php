    ...
    <div class="flex justify-between mb-4">
        <div class="w-1/2">
            <form action="{{ route('master.manufacture.store') }}" method="POST">
                ...
                <button type="submit" class="bg-blue-500 text-white rounded-lg hover:bg-blue-600 px-6 py-2  ">Submit</button>
            </form>
        </div>
        ...
        <table class="min-w-full text-sm text-center">
            ...
            <tbody class="text-gray-700">
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                    <td class="py-3 px-6">{{ $loop->iteration + ($manufactures->currentPage() - 1) * $manufactures->perPage() }}</td>
