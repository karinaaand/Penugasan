...
<div class="container mx-auto mt-8">
    <!-- Header -->
    <h1 class="text-3xl font-bold text-gray-700 mb-6">Jenis Obat</h1>

    <!-- Add Button -->
    <div class="flex justify-between mb-4">
        <div class="w-1/2">
            <input type="text" class="border border-gray-300 rounded p-2 w-3/4" placeholder="Inputkan Jenis obat">
        ...
        <table class="min-w-full leading-normal">
            ...
            <tbody class="text-gray-700 text-sm font-light">
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                    ...
                    <td class="py-3 px-6 text-left">Jenis {{ $i }}</td>
