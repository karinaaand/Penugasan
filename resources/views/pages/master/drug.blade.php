...
<div class="p-6 bg-white rounded-lg shadow-lg">
    <div class="flex justify-between mb-4">
        <a href="{{ route('master.drug.create') }}">
            <button class="bg-green-500 text-white font-semibold px-6 py-2 rounded-lg shadow hover:bg-green-600">+ Tambah</button>
        </a>
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-6 flex justify-center">
                            <a href="{{ route('master.drug.edit', $item->id) }}"
                                class="h-max flex items-center bg-indigo-200 text-white text-sm px-2 py-2 rounded-lg shadow hover:bg-indigo-500 mr-2">
