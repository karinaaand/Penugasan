...
@section('container')
    ...
    <div class="container mx-auto p-4">
        <div class="flex items-center mb-4">
            <a class="text-blue-600 flex items-center mr-4" href="{{ route('management.bill.index') }}">
                <i class="fas fa-arrow-left mr-2"></i></a>
            <h1 class="text-2xl font-bold">Laporan Tagihan</h1>
        </div>
    </div>
    <div class="rounded-lg bg-white p-6 shadow-lg">
        <div class="mb-4 flex items-center">
            ...
            <div class="flex flex-1 items-center justify-center">
                ...
                <input type="text" id="lpb"
                    class="mr-2 border-b border-gray-300 focus:border-gray-500 focus:outline-none" />
            </div>
            <div class="flex flex-1 justify-end">
                <button id="printButton"
                    class="rounded-lg font-inter text-lg  bg-yellow-300 px-4 py-2 font-bold text-black">CETAK</button>
            </div>
        </div>
        ...
        <div class="mt-4 flex items-center justify-end">
            ...
            <input type="text" value="Rp 750.000"
                class="w-48 border-b border-gray-400 text-center focus:border-black focus:outline-none" readonly />
        </div>
    </div>
    <script>
