...
@section('container')
    ...
    <head>
        <title>Detail Buang</title>
        <script src="https://cdn.tailwindcss.com"></script>
        <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" rel="stylesheet" />
    </head>
    <div class="container mx-auto p-4">
        <div class="flex items-center mb-8">
            <a class="text-blue-600 flex items-center mr-4" href="{{ route('management.trash.index') }}">
                <i class="fas fa-arrow-left mr-2"></i></a>
            <h1 class="text-3xl font-bold">Detail Buang</h1>
        </div>
    </div>
    <div class="rounded-lg bg-white p-6 shadow-lg">
        <div class="mb-8 grid grid-cols-2 gap-4">
            <div>
                ...
                <p class="text-base font-inter text-gray-600">Paracetamol</p>
            </div>
            <div>
                <label class="block text-lg  font-inter text-gray-700">Tanggal Expired</label>
                <p class="text-base font-inter text-gray-600">20/12/2024</p>
            </div>
        </div>
        ...
        <div class="mb-4 grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="number" class="h-10 w-full text-base font-inter rounded border border-gray-300 p-4"
                    placeholder="Inputkan jumlah obat" />
            </div>
            <div>
                <label class="block text-lg font-inter text-gray-700">Deskripsi</label>
                <textarea class="h-40 w-full text-base font-inter rounded border border-gray-300 p-4" placeholder="Tuliskan alasan"
                    rows="4"></textarea>
            </div>
        </div>
        ...
        <div class="mt-4 flex justify-end">
            <button onclick="showToast()"
                class="rounded-lg bg-pink-500 px-6 py-2 text-white hover:bg-pink-600 text-base font-inter">
                Buang
            </button>
        </div>
