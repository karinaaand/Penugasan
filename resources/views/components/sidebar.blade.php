       ...
       <li>
        ...
        <li>
          <button type="button" class="flex items-center w-full p-2 text-base transition duration-75 rounded-lg group
                @if(str_contains(request()->route()->getName(),'masterdata'))
                    bg-gray-300 hover:bg-gray-400
                @else
                    bg-gray-100 hover:bg-gray-300 text-gray-900
                @endif" aria-controls="dropdown-masterdata" data-collapse-toggle="dropdown-masterdata">
            ...
            <button type="button" class="flex items-center w-full p-2 text-base transition duration-75 rounded-lg group
                ...
                @else
                    bg-gray-100 hover:bg-gray-300 text-gray-900
                @endif" aria-controls="dropdown-inventory" data-collapse-toggle="dropdown-inventory">
               ...
               <button type="button" class="flex items-center w-full p-2 text-base transition duration-75 rounded-lg group
                    ...
                    @else
                        bg-gray-100 hover:bg-gray-300 text-gray-900
                    @endif" aria-controls="dropdown-klinik" data-collapse-toggle="dropdown-klinik">
        ...
        <li>
               <button type="button" class="flex items-center w-full p-2 text-base transition duration-75 rounded-lg group
                    ...
                    @else
                        bg-gray-100 hover:bg-gray-300 text-gray-900
                    @endif" aria-controls="dropdown-laporan" data-collapse-toggle="dropdown-laporan">
            ...
            <button type="button" class="flex items-center w-full p-2 text-base transition duration-75 rounded-lg group
                ...
                @else
                    bg-gray-100 hover:bg-gray-300 text-gray-900
                @endif" aria-controls="dropdown-manajementransaksi" data-collapse-toggle="dropdown-manajementransaksi">
            ...
            <li>
                <a href="{{ route('user.index') }}" class="flex items-center p-2 transition duration-75 rounded-lg group 
                @if(str_contains(request()->route()->getName(), 'user.index'))
                    bg-blue-500 hover:bg-gray-400 text-white
                @else
                    bg-gray-100 hover:bg-gray-300 text-gray-900
                @endif
                ">
                    <svg width="20px" height="20px" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="mr-0">
