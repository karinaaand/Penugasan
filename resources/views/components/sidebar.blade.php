    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-abu">
       <ul class="space-y-2 font-medium">
        <li>
            ...
            <a href="{{ route('dashboard') }}" class="flex items-center p-2 bg-blue-500 rounded-lg dark:text-white hover:bg-blue-600 dark:hover:bg-blue-700 group mb-4">
        ...
        <li class="flex items-center justify-between pt-3 pb-1 text-gray-400 uppercase">
          ...
          <li>
             <button type="button" class="flex items-center w-full p-2 text-base bg-gray-300 transition duration-75 rounded-lg group hover:bg-gray-300" aria-controls="dropdown-masterdata" data-collapse-toggle="dropdown-masterdata">
             ...
             @if(str_contains(request()->route()->getName(),'master'))
                 block
             @else
                 hidden
             @endif">
                         <li>
                    <a href="{{ route('master.category.index') }}" class="flex items-center space-x-5 p-2 transition duration-75 rounded-lg group 
                    @if(str_contains(request()->route()->getName(),'master.category'))
                    bg-blue-500
                    hover:bg-gray-200
                    text-white
                    @else
            ...
            <li>
                <a href="{{ route('master.variant.index') }}" class="flex items-center space-x-5 p-2 transition duration-75 rounded-lg group
                @if(str_contains(request()->route()->getName(),'master.variant'))
                    bg-blue-500
                    hover:bg-gray-200
                    text-white
                    @else
            ...
            <li>
                <a href="{{ route('master.manufacture.index') }}" class="flex items-center space-x-5 p-2 transition duration-75 rounded-lg group
                @if(str_contains(request()->route()->getName(),'master.manufacture'))
                    bg-blue-500
                    hover:bg-gray-200
                    text-white
                    @else
            ...
            <li>
                <a href="{{ route('master.vendor.index') }}" class="flex items-center space-x-5 p-2 transition duration-75 rounded-lg group
                @if(str_contains(request()->route()->getName(),'master.vendor'))
                    bg-blue-500
                    hover:bg-gray-200
                    text-white
                    @else
            ...
            <li>
                <a href="{{ route('master.drug.index') }}" class="flex items-center space-x-5 p-2 transition duration-75 rounded-lg group
                @if(str_contains(request()->route()->getName(),'master.drug'))
                    bg-blue-500
                    hover:bg-gray-200
                    text-white
                    @else
            ...
            <li>
                <button type="button" class="flex items-center w-full p-2 text-base transition duration-75 rounded-lg group bg-gray-300 hover:bg-gray-300" aria-controls="dropdown-inventory" data-collapse-toggle="dropdown-inventory">
                ...
                @if(str_contains(request()->route()->getName(),'inventory'))
                    block
                @else
                    hidden
                @endif">
                    <li>
                        <a href="{{ route('inventory.inflows.index') }}" class="flex items-center space-x-5 p-2 transition duration-75 rounded-lg group
                        @if(str_contains(request()->route()->getName(),'inventory.inflow'))
                    bg-blue-500
                    hover:bg-gray-200
                    text-white
                    @else
                    ...
                    <li>
                        <a href="{{ route('inventory.stocks.index') }}" class="flex items-center space-x-5 p-2 transition duration-75 rounded-lg group
                        @if(str_contains(request()->route()->getName(),'inventory.stock'))
                    bg-blue-500
                    hover:bg-gray-200
                    text-white
                    @else
               ...
               <li>
                <button type="button" class="flex items-center w-full p-2 text-base transition duration-75 rounded-lg group bg-gray-300 hover:bg-gray-300" aria-controls="dropdown-klinik" data-collapse-toggle="dropdown-klinik">
                ...
                @if(str_contains(request()->route()->getName(),'clinic'))
                    block
                @else
                    hidden
                @endif">
                    <li>
                        <a href="{{ route('clinic.inflows.index') }}" class="flex items-center space-x-5 p-2 transition duration-75 rounded-lg group
                        @if(str_contains(request()->route()->getName(),'clinic.inflow'))
                    bg-blue-500
                    hover:bg-gray-200
                    text-white
                    @else
                    ...
                    <li>
                        <a href="{{ route('clinic.stocks.index') }}" class="flex items-center space-x-5 p-2 transition duration-75 rounded-lg group
                        @if(str_contains(request()->route()->getName(),'clinic.stock'))
                    bg-blue-500
                    hover:bg-gray-200
                    text-white
                    @else
               ...
               <li>
                <button type="button" class="flex items-center w-full p-2 text-base transition duration-75 rounded-lg group bg-gray-300 hover:bg-gray-300" aria-controls="dropdown-laporan" data-collapse-toggle="dropdown-laporan">
                ...
                @if(str_contains(request()->route()->getName(),'report'))
                    block
                @else
                    hidden
                @endif">
                    <li>
                        <a href="{{ route('report.drugs.index') }}" class="flex items-center space-x-5 p-2 transition duration-75 rounded-lg group
                        @if(str_contains(request()->route()->getName(),'report.drug'))
                    bg-blue-500
                    hover:bg-gray-200
                    text-white
                    @else
                    ...
                    <li>
                        <a href="{{ route('report.transactions.index') }}" class="flex items-center space-x-5 p-2 transition duration-75 rounded-lg group
                        @if(str_contains(request()->route()->getName(),'report.transaction'))
                    bg-blue-500
                    hover:bg-gray-200
                    text-white
                    @else
            ...
            <li>
                <button type="button" class="flex items-center w-full p-2 text-base transition duration-75 bg-gray-300 rounded-lg group hover:bg-gray-300" aria-controls="dropdown-manajementransaksi" data-collapse-toggle="dropdown-manajementransaksi">
                ...
                @if(str_contains(request()->route()->getName(),'management'))
                    block
                @else
                    hidden
                @endif">
                    <li>
                        <a href="{{ route('management.bill.index') }}" class="flex items-center space-x-5 p-2 transition duration-75 rounded-lg group
                        @if(str_contains(request()->route()->getName(),'management.bill'))
                    bg-blue-500
                    hover:bg-gray-200
                    text-white
                    @else
                    ...
                    <li>
                        <a href="{{ route('management.retur.index') }}" class="flex items-center space-x-5 p-2 transition duration-75 rounded-lg group
                        @if(str_contains(request()->route()->getName(),'management.retur'))
                    bg-blue-500
                    hover:bg-gray-200
                    text-white
                    @else
                    ...
                    <li>
                        <a href="{{ route('management.trash.index') }}" class="flex items-center space-x-5 p-2 transition duration-75 rounded-lg group
                        @if(str_contains(request()->route()->getName(),'management.trash'))
                    bg-blue-500
                    hover:bg-gray-200
                    text-white
                    @else
            ...
            <li>
                <a href="{{ route('user.index') }}" class="flex items-center p-2 bg-gray-300 rounded-lg hover:bg-blue-500 group mb-4">
