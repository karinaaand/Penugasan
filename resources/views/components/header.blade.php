            ...
            <div class="bg-white w-72 rounded-lg shadow-lg p-6 absolute top-4 right-4 text-left">
               ...
               <div class="relative w-16 h-16 bg-gray-200 rounded-full flex justify-start">
                ...
                <div class="mt-4 flex justify-center">
                    <!-- Icon Setting -->
                    <a href="{{ route('user.settings') }}" class="bg-gray-300 text-gray-700 py-2 px-4 rounded-lg flex items-center justify-center w-full text-center">
                ...
                <div class="mt-10 flex justify-center">
                    <!-- Icon Logout -->
                    <a href="{{ route('user.logout') }}" class="bg-gray-300 text-gray-700 py-2 px-4 rounded-lg flex items-center justify-center w-full text text-center">
